...
def holmes_sync_toolsets_status(dal: SupabaseDal, config) -> None:
    ...
    logging.info(f"Enabled toolsets1: {toolsets_for_sync_by_name.keys()}")
    ...
    toolsets_names_csv = ", ".join(config.enabled_toolsets_names)
    logging.info(f"Enabled toolsets: {toolsets_names_csv}")
